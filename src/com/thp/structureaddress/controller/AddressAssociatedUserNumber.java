...
import com.thp.structureaddress.webservice.forwardaddress.SOAServicePort;
import com.thp.structureaddress.webservice.forwardaddress.model.GetStrucAddressRequest;
import com.thp.structureaddress.webservice.forwardaddress.model.GetStrucAddressResponse;
import com.thp.structureaddress.webservice.forwardaddress.model.STRUCADDROut;
/**
 * 
 * @author dingjinyang
 * 地址查询用户号集合接口
